  ...
  <div class="page-container">
    <el-card>
      ...
      <template v-if="viewMode === 'table'">
        <el-table :data="logs" v-loading="loading" stripe @row-click="openDetail" style="cursor:pointer">
...
.timeline-user { color: #606266; font-weight: 500; }
.timeline-resource { color: #909399; font-size: 13px; }
.timeline-detail { color: #303133; font-size: 13px; margin-bottom: 6px; }
.timeline-meta { color: #909399; font-size: 12px; display: flex; gap: 16px; }
