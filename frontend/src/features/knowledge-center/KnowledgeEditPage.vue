...
.step-block { background: #f5f7fa; padding: 8px; border-radius: 4px; margin-bottom: 8px; }
.step-num { width: 22px; height: 22px; background: #409eff; color: #fff; border-radius: 50%; text-align: center; line-height: 22px; font-size: 11px; display: inline-block; }
.action-num { background: #e6a23c; }
.verify-num { background: #67c23a; }
.richtext-toolbar { padding: 8px; border: 1px solid #dcdfe6; border-bottom: none; border-radius: 4px 4px 0 0; background: #f5f7fa; }
...
.richtext-editor:focus { border-color: #409eff; }
</style>
