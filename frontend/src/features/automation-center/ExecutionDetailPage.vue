<template>
 ...
 :data="steps"v-if="steps.length > 0"
    ...
    <!-- Approve Action -->
    <div class="autops-card mt-lg" v-if="execution && execution.status === 'pending'" >
      <div class="autops-card-header">
                <span>审批操作</span>
      </div>
      <el-form :inline="true">
    ...
    <div class="autops-card mt-lg" v-if="execution && (execution.status === 'completed' || execution.status === 'failed')" >
      <div class="autops-card-header">
                <span>执行结果</span>
      </div>
    ...
    <div class="autops-card mt-lg" v-if="execution && (execution.status === 'completed' || execution.status === 'failed')"  v-loading="verificationLoading">
