            ...
            <el-card shadow="hover" class="version-card">
              <div class="version-card-header">
                ...
                <div class="version-actions">
                  <el-button v-if="ver.status === 'draft'" plain type="primary" size="small" @click="publishVersion(ver)">
                    发布
                  </el-button>
                  <el-button plain type="info" size="small" @click="viewContent(ver)">查看内容</el-button>
                </div>
              </div>
