<template>
  <div class="p-6">
    ...
    <p class="page-desc text-tertiary mb-md">日志源、匹配规则、命中数量、样例日志</p>
    <el-table :data="tableData" stripe v-loading="loading" empty-text="暂无数据">
      <el-table-column prop="log_source" label="日志源" min-width="140" show-overflow-tooltip />
      <el-table-column prop="match_rule" label="匹配规则" min-width="160" show-overflow-tooltip />
