...
def upgrade() -> None:
    # --- Recreate tables that were accidentally dropped ---
    ...
    op.create_table('ai_analyses',
        ...
        sa.Column('duration_ms', mysql.INTEGER(), autoincrement=False, nullable=True),
        sa.Column('feedback_rating', mysql.INTEGER(), autoincrement=False, nullable=True),
    ...
    op.create_index('ix_anomalies_asset_id', 'anomalies', ['asset_id'], unique=False)
